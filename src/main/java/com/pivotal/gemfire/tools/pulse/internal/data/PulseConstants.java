...
public class PulseConstants {
  ...
  // DEFAULT CONFIGUARTION VALUES FOR PULSE LOGGER
  // Log File
  public static final String PULSE_LOG_FILE_NAME = APP_NAME + ".log";
  // Log File location
  ...
  public static final String SYSTEM_PROPERTY_PULSE_EMBEDDED_GFXD = "pulse.embedded.gfxd";
  ...
  public static final String MBEAN_ATTRIBUTE_TOTALHEAPSIZE = "MaxMemory";
  public static final String MBEAN_ATTRIBUTE_USEDHEAPSIZE = "UsedMemory";
  public static final String MBEAN_ATTRIBUTE_OFFHEAPFREESIZE = "OffHeapFreeMemory";
  public static final String MBEAN_ATTRIBUTE_OFFHEAPUSEDSIZE = "OffHeapUsedMemory";
  ...
  public static final String MBEAN_ATTRIBUTE_CURRENTHEAPSIZE = "UsedMemory";
  public static final String MBEAN_ATTRIBUTE_MAXIMUMHEAPSIZE = "MaxMemory";
  ...
  public static final String[] MEMBER_MBEAN_ATTRIBUTES = {
      ...
      MBEAN_ATTRIBUTE_CURRENTHEAPSIZE, MBEAN_ATTRIBUTE_MAXIMUMHEAPSIZE,
